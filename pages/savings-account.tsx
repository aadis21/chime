...
const SavingsAccountPage: NextPageWithLayout = () => {
  return (
    <>
      <Head>
        <title>
          ChimePay High Interest Savings | Earn 1.50% APY on Any Balance
        </title>
        <meta name="description" content="ChimePay Clone Account Savings" />
      </Head>
      ...
      >
        <small>High Yield ChimePay Savings Account</small>
      ...
      >
        ...
        <p>
          ...
          how the ChimePay Savings Account works.
        </p>
      </DualSection>
